...
call s:highlight_helper("Visual", "#333", "#7FC1CA")
call s:highlight_helper("VisualNOS", "#333", "#7FC1CA")
call s:highlight_helper("Folded", "#7FC1CA", "")
call s:highlight_helper("FoldColumn", "#7FC1CA", "")
call s:highlight_helper("IncSearch", "#7FC1CA", "#222")
call s:highlight_helper("Search", "#7FC1CA", "#222")
call s:highlight_helper("WildMenu", "#222", "#7FC1CA")
call s:highlight_helper("ToolbarButton", "#222", "#7FC1CA")
call s:highlight_helper("Question", "#7FC1CA", "")
call s:highlight_helper("MoreMsg", "#7FC1CA", "")
call s:highlight_helper("ModeMsg", "#7FC1CA", "")
call s:highlight_helper("StatusLine", "#7FC1CA", "#222")
call s:highlight_helper("StatusLineTerm", "#7FC1CA", "#222")
call s:highlight_helper("TabLineSel", "#7FC1CA", "#333")
call s:highlight_helper("PmenuSel", "#555", "#7FC1CA")
call s:highlight_helper("PmenuThumb", "#7FC1CA", "#7FC1CA")
call s:highlight_helper("CtrlPMatch", "#333", "#7FC1CA")

" VERSION CONTROL
call s:highlight_helper("DiffAdd", "#333", "#A8CE93")
call s:highlight_helper("DiffChange", "#333", "#F2C38F")
call s:highlight_helper("DiffDelete", "#DF8C8C", "")
call s:highlight_helper("DiffText", "#333", "#F2C38F", "BOLD")
